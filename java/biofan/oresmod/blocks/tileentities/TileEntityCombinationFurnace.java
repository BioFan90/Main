package biofan.oresmod.blocks.tileentities;

import net.minecraft.tileentity.TileEntity;
import biofan.oresmod.blocks.machines.BlockCombinationFurnace;
import biofan.oresmod.blocks.recipes.CombinationFurnaceRecipes;
...
import net.minecraftforge.items.ItemStackHandler;
	...
	public class TileEntityCombinationFurnace extends TileEntity 
	{
		...
		public static boolean isBurning(TileEntityCombinationFurnace te) 
		{
		...
		{	
			...
			{
				--this.burnTime;
				BlockCombinationFurnace.setState(true, world, pos);
			}
			...
			else
			{
				...
				{
					ItemStack output = CombinationFurnaceRecipes.getInstance().getSinteringResult(inputs[0], inputs[1]);
					if(!output.isEmpty())
					{
						smelting = output;
						cookTime++;
		...
		private boolean canSmelt() 
		{
			...
			{
				ItemStack result = CombinationFurnaceRecipes.getInstance().getSinteringResult((ItemStack)this.handler.getStackInSlot(0), (ItemStack)this.handler.getStackInSlot(1));	
