package biofan.oresmod.blocks.recipes;
...
{	
	...
	{
		addSinteringRecipe(new ItemStack(ModItems.SULFUR), new ItemStack(Items.GOLD_INGOT), new ItemStack(ModItems.INGOT_VULCANITE), 5.0F);
	}
